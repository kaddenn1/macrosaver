...
const title = "Tracked Supplement Brands";
const description =
  "Browse supplement brands in the MacroSaver catalog, with a quick introduction and links to each tracked product lineup.";

export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: `${SITE_URL}/brands` },
  openGraph: { title: `${title} | MacroSaver`, description, url: `${SITE_URL}/brands` },
};
      ...
      <div className="w-full max-w-[1600px] mx-auto pt-10 px-4 sm:px-6 lg:px-8 pb-24">
        <div className="mb-10 border-b border-gray-800 pb-6">
          ...
          <p className="text-gray-400 text-sm mt-2 max-w-[650px]">
            Every brand in our catalog, in one place. Pick one to see the products and
            serving-level value data we track.
          </p>
        </div>
